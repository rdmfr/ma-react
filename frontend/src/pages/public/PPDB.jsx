                            ...
                            <div className="p-7">
                                ...
                                {step === 1 && (
                                    <div className="mt-6 grid sm:grid-cols-2 gap-4" data-testid="ppdb-step-1">
                                        ...
                                        <div><label className="text-sm font-semibold text-brand-950">Tempat, Tanggal Lahir</label><input value={form.birth} onChange={e => setForm({...form, birth: e.target.value})} placeholder="Garut, 1 Jan 2008" className="mt-1.5 w-full rounded-xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-brand-500" /></div>
