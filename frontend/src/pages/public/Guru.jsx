        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14" data-testid="guru-page">
            ...
            <div className="mt-10 flex flex-col md:flex-row gap-4 bg-white rounded-2xl border border-slate-100 p-3">
                <div className="flex items-center gap-2 flex-1 bg-brand-50/40 rounded-xl px-4">
                    ...
                    <input value={q} onChange={e => setQ(e.target.value)} placeholder="Cari nama atau mata pelajaran..." className="flex-1 py-3 bg-transparent outline-none text-sm" data-testid="guru-search" />
                </div>
            ...
            {filtered.length === 0 && <div className="mt-10 text-center text-slate-500">Tidak ada guru yang cocok.</div>}
        </div>
    );
}
