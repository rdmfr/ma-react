...
export const teachers = [
    ...
    { id: 6, slug: "bambang-sutrisno", name: "Bambang Sutrisno, S.Pd", subject: "Sejarah", photo: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=400&q=80", bio: "Penggiat sejarah lokal Pemalang.", education: "S1 Sejarah, UNES", contact: "bambang.s@mapulosari.sch.id" },
...
export const news = [
    { id: 1, slug: "juara-osn-provinsi-2025", title: "Siswa MA Pulosari Juara OSN Matematika Tingkat Provinsi", category: "Prestasi", excerpt: "Ananda Rafli Firmansyah berhasil meraih medali emas pada Olimpiade Sains Nasional tingkat provinsi Jawa Tengah.", content: "Ananda Rafli Firmansyah dari kelas XII IPA 1 berhasil meraih medali emas pada Olimpiade Sains Nasional (OSN) bidang Matematika tingkat Provinsi Jawa Tengah tahun 2025. Prestasi ini mengantarkan Rafli untuk mewakili Jawa Tengah di tingkat nasional.\n\nPrestasi ini merupakan hasil dari pembinaan intensif yang dilakukan oleh tim guru Matematika MA Pulosari.", image: "https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?w=1200&q=80", author: "Admin", date: "2025-02-14", views: 1245 },
    ...
    { id: 5, slug: "kejuaraan-futsal-kabupaten", title: "Tim Futsal Putra Raih Runner-Up Kejuaraan Kabupaten", category: "Prestasi", excerpt: "Perjuangan tim futsal putra di kejuaraan antar madrasah Se-Kabupaten Pemalang.", content: "Tim futsal putra MA Pulosari meraih posisi runner-up dalam kejuaraan antar madrasah Se-Kabupaten Pemalang.", image: "https://images.unsplash.com/photo-1551958219-acbc608c6377?w=1200&q=80", author: "OSIS", date: "2025-01-28", views: 478 },
...
export const alumni = [
    { id: 1, name: "dr. Rizky Ananda", year: 2018, profession: "Dokter Umum - RSUD Pemalang", photo: "https://i.pravatar.cc/120?img=12", testimonial: "MA Pulosari mengajarkan saya bahwa ilmu tanpa akhlak adalah kosong. Alhamdulillah, kini saya bisa mengabdi." },
